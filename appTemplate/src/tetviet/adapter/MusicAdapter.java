...
public class MusicAdapter extends BaseAdapter {
	...
	public MusicAdapter(Context context, List<ParseObject> mApps) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (itemData != null) {
            ...
            holder.tv1.setText(itemData.getString("SongName"));

            String videoId = YouTubeUrlParser.getVideoId(itemData.getString("SongUrl"));
