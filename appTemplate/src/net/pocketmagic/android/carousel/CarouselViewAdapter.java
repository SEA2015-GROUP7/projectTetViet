...
//    		 empty.recycle();
    		 CarouselViewItem scaIv = new CarouselViewItem(mContext, R.drawable.icon_app, "empty doc", m_w, m_h);
...
//    		 originalImage.recycle();
    	 CarouselViewItem scaIv = new CarouselViewItem(mContext, mDocus.get(position).getImageId(), mDocus.get(position).getItemName(), m_w, m_h);
